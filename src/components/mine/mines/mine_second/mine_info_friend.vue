<template>
 <div class='Sign_con'>
   	   <div class="Sign_head">
   	   	  <router-link :to="{path:'/info'}" class='Back' tag='div'>
   	...
   	<div class="Border">
   	   <div class="Care_list">
   	   	  <div class="Care_left">
   	   	    <div class="Care_img">
   	   	  	  <img src="http://andypoppy.oss-cn-beijing.aliyuncs.com/images/images/fans02.png" alt="">
            </div>
            <div class="Care_words">
            	<p>小明</p>
            	<p><span>女</span><span>18-35岁</span><span>混合型肌肤</span></p>
            </div>
   	   	  </div>
